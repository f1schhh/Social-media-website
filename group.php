...
<!-- Group banner -->
<div class="jumbotron jumbotron-fluid bg-dark text-white text-center bg-image" style="background-image: url(https://as01.epimg.net/en/imagenes/2018/06/21/football/1529614017_609310_1529614199_noticia_normal.jpg); background-size: cover; background-position:center;min-height: 40vh;">
  <div class="container">
    <h1 class="display-4">Leicester fan group</h1>
  </div>
</div>

<!-- Group members and posts -->
<div class="container mt-5">
  <div class="row">
    ...
    <div class="col-md-3">
      <h2>Group Members</h2>
      <div class="card mb-4">
        <img src="https://pbs.twimg.com/profile_images/772342671721455616/FE79-7Ev_400x400.jpg" class="card-img-left" alt="Profile 1">
        <div class="card-body">
